...
const validName = (value) => REGEX_NAME.test(value);
...
const validBucketStepFactor = (value) => Number.isFinite(value) || value === null || value === undefined;
module.exports.validBucketStepFactor = validBucketStepFactor;

const validBucketStepCount = (value) => Number.isFinite(value) || value === null || value === undefined;
module.exports.validBucketStepCount = validBucketStepCount;

const validBucketStepStart = (value) => Number.isFinite(value) || value === null || value === undefined;
module.exports.validBucketStepStart = validBucketStepStart;

const validType = (value) => value === "counter" || value === "histogram" || value === "gauge" || value === "summary";
