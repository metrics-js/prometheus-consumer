...
test("metrics with labels", (t) => {
	...
	consumer.on("finish", () => {
		const result = consumer.registry.getSingleMetric("my_counter_with_labels");
		t.matchSnapshot(result);
		t.end();
	});
});
...
test("new metrics with labels", (t) => {
	...
	consumer.on("finish", () => {
		const result = consumer.registry.getSingleMetric("my_new_counter_with_labels");
		t.matchSnapshot(result);
		t.end();
	});
});
...
test(".override() sets a metric to be a histogram with specific buckets", (t) => {
	...
	consumer.on("finish", () => {
		const result = consumer.registry.getSingleMetric("overridden_histogram");
		t.matchSnapshot(result);
		t.end();
	});
});
...
test(".override() sets a counter with custom labels", (t) => {
	...
	consumer.on("finish", () => {
		const result = consumer.registry.getSingleMetric("custom_label_counter");
		t.matchSnapshot(result);
		t.end();
	});
...
test(".override() sets a histogram with custom labels", (t) => {
	...
	consumer.on("finish", () => {
		const result = consumer.registry.getSingleMetric("custom_label_histogram");
		t.matchSnapshot(result);
		t.end();
	});
...
test("should have correct bucket count", (t) => {
	...
	consumer.on("finish", () => {
		const result = consumer.registry.getSingleMetric("histogram_with_buckets");
